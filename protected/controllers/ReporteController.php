...
class ReporteController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_GET['alumno_aid']) && isset($_GET['semana_did']) && isset($_GET['grupo_did']))
		{
			$model->alumno_aid = $_GET['alumno_aid'];
			$model->semana_did = $_GET['semana_did'];
			$model->grupo_did = $_GET['grupo_did'];		
		...
		if(isset($_POST['Reporte']))
		{
			...
			if($model->save())
				$this->redirect(array('maestro/reportesemanal', 
								'alumno_did'=>$_GET['alumno_aid'],
	...
	{
		$model=Reporte::model()->findByPk((int)$id);
		if($model===null)
