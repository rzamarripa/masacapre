...
array('label'=>'Crear Planeación', 'url'=>array('create',
												...
												'maestroid' => $_GET["maestroid"],
												'matid' => $_GET['matid'],
												'tipoUsuario' => 2,)),
array('label'=>'Subir archivo', 'url'=>array(	'archivo/create',
												'materia' => $_GET["materia"],
												'maestroid' => $_GET["maestroid"],
												'matid' => $_GET['matid'],
												'tipoUsuario' => 2,)),
...
$queryPlaneacionPorMateria ='select p.id, p.materia_aid as matid, p.consecutivo, p.semestre,  p.estrategia, p.tema, p.bloque, p.sesiones,
							tiempo_estimado, e.id as estatus, e.nombre as nombreestatus
...
<div class="tabbable"> <!-- Only required for left/right tabs -->
	...
	<div class="tab-content">
    	<div class="tab-pane active" id="tab01">
			...
			<div class="tabbable"> <!-- Only required for left/right tabs -->
				<ul class="nav nav-tabs">
					<li class="active"><a href="#tab2" data-toggle="tab"><i style="color:green;" class="icon-edit"></i> Borradores</a></li>
					<li><a href="#tab1" data-toggle="tab"><i class="icon-share"></i> Liberadas</a></li>
					...
					<li><a href="#tab5" data-toggle="tab"><i class="icon-trash"></i> Papelera</a></li>
				</ul>
				<div class="tab-content">
			    	<div class="tab-pane" id="tab1">
									...
									<td style="width:20px;">
										<div class="btn-group">
											...
											<ul class="dropdown-menu">
												<li>
													<?php echo CHtml::link('<i class="icon-edit"></i> Sin liberar', "#",
													array('submit'=> array('planeacion/cambiarestatus', 'id'=>$valor["id"], 'estatus'=>2, 'tipoUsuario' => 2),
													'confirm' => 'Estás seguro que quiere pasar esta planeación a Borrador?')); ?>
												</li>
												<li>
												...
												<li>
													...
													array('planeacion/create','planeacion_id'=>$valor["id"], 'tipoUsuario'=>2, 'matid'=>$_GET['matid'],
													'maestroid'=>$_GET["maestroid"])); ?>
												</li>
												<li>
													<?php echo CHtml::link('<i class="icon-print"></i> Imprimir',
													array('planeacion/detalle', 'id'=>$valor["id"])); ?>
												</li>
												<li>
													<?php echo CHtml::link('<i class="icon-trash"></i> En Papelera', "#",
													array('submit'=> array('planeacion/cambiarestatus', 'id'=>$valor["id"], 'estatus'=>5, 'tipoUsuario' => 2),
						...
						<?php }
								...
								echo '<h6>No hay planeaciones todavía, inicie ' . CHtml::link('creando la primera', array('create', 'matid'=>$_GET["matid"], 'maestroid' => $_GET['maestroid'], 'tipoUsuario' => 2)) . '</h6>';
							}
						?>
								...
								<tr>
									<td style="width:20px;">
										<div class="btn-group">
											...
											<ul class="dropdown-menu">
												<li>
													<?php echo CHtml::link('<i class="icon-check"></i> Liberar', "#",
													array('submit'=> array('planeacion/cambiarestatus', 'id'=>$valor["id"], 'estatus'=>1, 'tipoUsuario' => 2),
													'confirm' => 'Estás seguro que quiere pasar esta planeación a Liberado?')); ?>
												</li>
												<li>
													<?php echo CHtml::link('<i class="icon-list-alt"></i> Detalle Planeación', array('planeacion/view', 'id'=>$valor["id"])); ?>
												</li>
												<li>
													<?php echo CHtml::link('<i class="icon-trash"></i> En Papelera', "#",
													array('submit'=> array('planeacion/cambiarestatus', 'id'=>$valor["id"], 'estatus'=>5, 'tipoUsuario' => 2),
					...
					<div class="tab-pane" id="tab3">
									...
									<td style="width:20px;">
										<div class="btn-group">
											...
											<ul class="dropdown-menu">
												...
												<li>
													<?php echo CHtml::link('<i class="icon-print"></i> Imprimir', array('planeacion/detalle', 'id'=>$valor["id"])); ?>
												</li>
											</ul>
										</div>
									</td>
						...
						<?php }
								...
								array('create', 'matid'=>$_GET["matid"], 'maestroid' => $_GET['maestroid'], 'tipoUsuario' => 2)) . '</h6>';
							}
						?>
					</div>
												...
												<div class="btn-group">
													...
													<ul class="dropdown-menu">
														...
														<li>
															...
															array('submit'=> array('planeacion/delete',
															'id'=>$valor["id"], 'estatus'=>5, 'tipoUsuario' => 2),
    	...
    	<div class="tab-pane" id="tab02">
    		<div class="tabbable"> <!-- Only required for left/right tabs -->
				<ul class="nav nav-tabs">
					<li class="active"><a href="#tab021" data-toggle="tab"><i style="color:green;" class="icon-edit"></i> Borrados</a></li>
					<li><a href="#tab022" data-toggle="tab"><i class="icon-share"></i> Liberados</a></li>
				...
				<div class="tab-content">
			    	...
			    	<div class="tab-pane active" id="tab021">
										...
										<td style="width:20px;">
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													<li>
													<?php echo CHtml::link('<i class="icon-check"></i> Liberar', "#",
													array('submit'=> array('archivo/cambiarestatus', 'id'=>$valor["id"], 'estatus'=>1, 'tipoUsuario' => 2),
													'confirm' => 'Estás seguro que quiere pasar este Archivo a Liberado?')); ?>
												</li>
													<li>
														<?php
															$arch = $file= Yii::app()->BaseUrl . DIRECTORY_SEPARATOR . 'recursos' . DIRECTORY_SEPARATOR . $valor["nombre"]; 																		echo CHtml::link('<i class="icon-download"></i> Descargar',$arch);
														?>
													</li>
													<li>
													...
													<li>
														<?php echo CHtml::link('<i class="icon-trash"></i> En Papelera', "#",
														array('submit'=> array('archivo/cambiarestatus', 'id'=>$valor["id"], 'estatus'=>5, 'tipoUsuario' => 2),
						...
						<?php }
								...
								echo '<h6>No hay archivos todavía, inicie ' . CHtml::link('subiendo el primero', array('archivo/create', 'matid'=>$_GET["matid"], 'maestroid' => $_GET['maestroid'], 'tipoUsuario' => 2)) . '</h6>';
							}
						?>
			    	</div>
			    	<!-- Liberado -->
										...
										<td style="width:20px;">
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													<li>
														<?php echo CHtml::link('<i class="icon-edit"></i> Sin liberar', "#",
														array('submit'=> array('archivo/cambiarestatus', 'id'=>$valor["id"], 'estatus'=>2, 'tipoUsuario' => 2),
														'confirm' => 'Estás seguro que quiere pasar este Archivo a Borrador?')); ?>
													</li>
													<li>
														<?php
															$arch = $file= Yii::app()->BaseUrl . DIRECTORY_SEPARATOR . 'recursos' . DIRECTORY_SEPARATOR . $valor["nombre"]; 																		echo CHtml::link('<i class="icon-download"></i> Descargar',$arch);
										...
										<td style="width:20px;">
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													...
													<li>
														<?php echo CHtml::link('<i class="icon-trash"></i> Eliminar', "#",
														array('submit'=> array('archivo/delete', 'id'=>$valor["id"],
														'nombre'=>$valor["nombre"], 'tipoUsuario'=>2),
